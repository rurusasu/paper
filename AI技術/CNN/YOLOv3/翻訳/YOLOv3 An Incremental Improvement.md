...
# 3. How We Do
![表3]()
表3.これらすべてのテーブルを真剣に盗んでいるだけです[9]。ゼロから作成するには非常に時間がかかります。はい、YOLOv3は問題なく動作しています。 RetinaNetは、画像の処理に3：8_ほど長くかかることに注意してください。 YOLOv3はSSDバリアントよりもはるかに優れており、AP50メトリックの最新モデルに匹敵します。
